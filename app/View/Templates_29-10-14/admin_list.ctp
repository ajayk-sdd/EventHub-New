            ...
            <section class="tbldata">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabulardata">
                    <tr>
                        ...
                        <th style="width:32%;"><?php echo $this->Paginator->sort('EventTemplate.name', 'Image'); ?>
                        ...
                        <th style="width:8%;"><?php echo $this->Paginator->sort('EventTemplate.image', 'Status'); ?>
                        ...
                        <th style="width:16%;"><?php echo $this->Paginator->sort('EventTemplate.created', 'Created'); ?>
                            <span class="<?php echo ('EventTemplate.modified' == $this->Paginator->sortKey()) ? $this->Paginator->sortDir() : 'none'; ?><?php if ($this->Paginator->sortKey() == "created ASC") { ?> asc <?php } ?>">&nbsp;&nbsp;&nbsp;</span></th>
