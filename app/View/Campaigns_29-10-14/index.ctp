                        ...
                        <table style="width:100%;">
                            ...
                            <tbody>
                                <?php foreach ($campaigns as $campaign): ?>
                                    <tr>
                                        <td><?php if(isset($campaign['Campaign']['title']) && !empty($campaign['Campaign']['title'])) {
echo $campaign['Campaign']['title']; } else { echo $campaign['Campaign']['subject_line']; } echo "<br>Created " . date('l, F d, Y', strtotime($campaign["Campaign"]["created"])); ?></td>
